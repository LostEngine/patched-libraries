...
// Allow large enum variants for LSP protocol types (intentional design)
#![allow(clippy::large_enum_variant)]
// Allow Self type suggestions - prefer explicit type names for clarity in LSP types
#![allow(clippy::use_self)]
// Allow const fn suggestions - not critical for this library
#![allow(clippy::missing_const_for_fn)]
// Allow derive_partial_eq_without_eq - LSP types often contain floats or other non-Eq types
#![allow(clippy::derive_partial_eq_without_eq)]
// Allow documentation style preferences
#![allow(clippy::too_long_first_doc_paragraph)]
#![allow(clippy::doc_markdown)]
#![allow(clippy::doc_link_with_quotes)]
// Allow match_same_arms - sometimes explicit matching is clearer
#![allow(clippy::match_same_arms)]
// Allow redundant_pub_crate in test modules
#![allow(clippy::redundant_pub_crate)]
// Allow wildcard imports for internal modules
#![allow(clippy::wildcard_imports)]
// Allow string formatting style preferences
...
// Allow explicit patterns that may be clearer
#![allow(clippy::ignored_unit_patterns)]
#![allow(clippy::explicit_iter_loop)]
// Allow complexity in test macros
#![allow(clippy::cognitive_complexity)]
// Performance optimizations that may reduce readability
...
/// A snippet text edit is a special text edit that additionally supports
/// inserting text snippets using the Language Server Protocol's snippet syntax.
///
/// @since 3.18.0
#[derive(Debug, Eq, PartialEq, Clone, Default, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct SnippetTextEdit {
    ...
    pub range: Range,
    /// The snippet string to be inserted. The snippet string is expected to
    /// follow the Language Server Protocol's snippet syntax.
    pub snippet: String,
...
impl SnippetTextEdit {
    pub fn new(range: Range, snippet: String) -> SnippetTextEdit {
        SnippetTextEdit {
            range,
            snippet,
            annotation_id: None,
...
/// Enum representing one of three possible types.
///
/// @since 3.18.0
#[derive(Debug, Eq, PartialEq, Ord, PartialOrd, Clone, Deserialize, Serialize)]
#[serde(untagged)]
...
/// Server capabilities for the `textDocument/rangesFormatting` request.
///
/// @since 3.18.0
#[derive(Debug, Eq, PartialEq, Clone, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
