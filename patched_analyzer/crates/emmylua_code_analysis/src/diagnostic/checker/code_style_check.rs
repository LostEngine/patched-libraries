// use emmylua_codestyle::check_code_style; -- LostEngine
// use rowan::TextRange;
...
impl Checker for CodeStyleCheckChecker {
    ...
    fn check(_context: &mut DiagnosticContext, _semantic_model: &SemanticModel) {
        // LostEngine -- check_code_style doesn't work
